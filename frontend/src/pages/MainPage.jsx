...
export const MainPage = () => {
	...
	return (
		<div className="w-[1440px] h-[1024px] relative bg-green-100">
			...
			<div className="w-[289px] h-[19px] left-[81px] top-[30px] absolute text-amber-500 text-3xl font-bold font-['Raleway']">
				DJ Diary
			</div>
			...
			/>
			<img
				className="w-[55px] h-[47px] left-[12px] top-[23px] absolute"
				src={logo}
			/>
			<img
			...
			<div className="w-[76px] h-[31px] left-[1301px] top-[39px] absolute">
				...
				<div className="w-[66px] left-[5px] top-[5px] absolute text-center text-black text-sm font-medium font-['Raleway'] leading-[21px]">
					Logout
				</div>
			</div>
			<div className="w-24 h-24 left-[672px] top-[464px] absolute" />
			<div className="w-[105px] p-[5px] left-[1179px] top-[39px] absolute bg-white rounded-[5px] border border-amber-500 justify-center items-center gap-2.5 inline-flex">
				<div className="text-center text-amber-500 text-sm font-medium font-['Raleway'] leading-[21px]">
					Home
				</div>
			</div>
		</div>
